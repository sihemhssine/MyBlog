...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<MyblogAdapter, MyblogAdapterViewHolder> FBRA = new FirebaseRecyclerAdapter<MyblogAdapter, MyblogAdapterViewHolder>(
                MyblogAdapter.class,
                R.layout.card_items,
                MyblogAdapterViewHolder.class,
                mDatabase
        ) {
            @Override

            protected void populateViewHolder(MyblogAdapterViewHolder viewHolder, MyblogAdapter model, int position) {
    ...
    public static class MyblogAdapterViewHolder extends RecyclerView.ViewHolder{
        View mView;
        public MyblogAdapterViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
